...
export KAFKA_HOME=$TOOLS_HOME/kafka/$KAFKA_VER
...
export PATH=$JAVA_HOME/bin:$MAVEN_HOME/bin:$HADOOP_HOME/bin:$HADOOP_HOME/sbin:$HIVE_HOME/bin:$HBASE_HOME/bin:$KAFKA_HOME/bin:$PEGASUS_HOME:$PATH
