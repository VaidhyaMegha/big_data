...
$HADOOP_HOME/bin/hdfs dfs -rm -r -f /giraph

$HADOOP_HOME/bin/hdfs dfs -mkdir /giraph

$HADOOP_HOME/bin/hdfs dfs -copyFromLocal $PROJECT_HOME/giraph/tiny_graph.txt /giraph/tiny_graph.txt
...
$HADOOP_HOME/bin/hdfs dfs -cat /giraph/shortestpaths